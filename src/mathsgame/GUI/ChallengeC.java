...
public class ChallengeC extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChallengeC frame = new ChallengeC();
	...
	public ChallengeC() {
		...
		JLabel lblNewLabel = new JLabel("530");
		...
		JLabel lblNewLabel_6 = new JLabel("64");
		...
		JLabel lblNewLabel_5_1 = new JLabel("2.5");
		...
		btnNewButton.setBounds(498, 367, 135, 63);
		panel.add(btnNewButton);
		
		JLabel lblNewLabel_7 = new JLabel("2 Decimal places are enough");
		lblNewLabel_7.setForeground(Color.BLACK);
		lblNewLabel_7.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 20));
		lblNewLabel_7.setBounds(23, 367, 305, 30);
